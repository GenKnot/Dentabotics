  ...
  const headerContent = (
    <Fragment>
      <div className="navbar-brand w-100">
        <NextLink href="/" title={<img alt="logo" src={`/img/home/logo.png`} srcSet={`/img/home/logo.png 2x`} />} />
      </div>

      <div id="offcanvas-nav" data-bs-scroll="true" className="navbar-collapse offcanvas offcanvas-nav offcanvas-start">
        <div className="offcanvas-header d-lg-none">
          <h3 className="text-white fs-30 mb-0">Dentabotics</h3>
          <button
            type="button"
            aria-label="Close"
        ...
        <div className="offcanvas-body ms-lg-auto d-flex flex-column h-100">
          <ul className="navbar-nav">
            <li className="nav-item">
              <NextLink title="Home" className="nav-link" href="#home"/>
            </li>

            <li className="nav-item">
              <NextLink title="Solutions" className="nav-link" href="#solutions"/>
            </li>

            <li className="nav-item">
              <NextLink title="Technology" className="nav-link" href="#technology"/>
            </li>

            <li className="nav-item">
              <NextLink title="Products" className="nav-link" href="#products"/>
            </li>

            <li className="nav-item">
              <NextLink title="Roadmap" className="nav-link" href="#roadmap"/>
            </li>

            <li className="nav-item">
              <NextLink title="Team" className="nav-link" href="#team"/>
            </li>
          </ul>
