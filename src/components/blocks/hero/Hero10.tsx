        ...
        <div className="row">
          <div className="col-lg-8 col-xl-7 col-xxl-6 mx-auto">
            <h1 className="display-1 fs-60 mb-4 px-md-15 px-lg-0" style={slideInDownAnimate("0ms")}>
              Precision Robotics for Modern <span className="underline-3 style-3 primary">Dentistry</span>
            </h1>
            ...
            <div style={slideInDownAnimate("600ms")}>
              <NextLink title="Explore Technology" href="#Technology" className="btn btn-lg btn-primary rounded mb-5" />
            </div>
          </div>
        </div>
      </div>
